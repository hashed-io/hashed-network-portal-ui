...
q-form.q-pa-xl.q-gutter-y-md(@submit="submitForm")
    ...
    .row.items-center.q-col-gutter-md.q-my-sm
      .col-7
        q-input(
          ...
          outlined
          :label="$t('pages.nbv.common.description')"
          v-model="description"
    ...
    .row.items-center.q-col-gutter-md.q-my-sm
      .col-7
        q-input(
          ...
          outlined
          :label="$t('pages.nbv.common.recipientAddress')"
    ...
    .row.items-center.q-col-gutter-md.q-my-sm
      .col-7
        q-input(
          data-testid="amount"
          outlined
          :label="$t('pages.nbv.common.amountInSats')"
    ...
    q-btn.float-right.q-mb-md(
        ...
        :label="$t('pages.nbv.proposals.create_proposal')"
        color="primary"
        size="md"
        type="submit"
        no-caps
